...
📖 **Step-by-step install guide:** [Debian](https://debian.griffo.io/install-latest-yazi-in-debian.html) · [Ubuntu](https://debian.griffo.io/install-latest-yazi-in-ubuntu.html)
